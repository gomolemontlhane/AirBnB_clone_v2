...
class TestPEP8(unittest.TestCase):
    """Test for PEP8 style formatting."""

    def test_pep8_conformance(self):
        """Test that module conforms to PEP8."""
        pep8style = pycodestyle.StyleGuide(quiet=True)
        result = pep8style.check_files(['models/amenity.py'])
        self.assertEqual(result.total_errors, 0,
                         "Found style errors (and warnings).")


class TestAmenityInheritBaseModel(unittest.TestCase):
...
class TestAmenityBaseModel(unittest.TestCase):
    """Test the Amenity class with BaseModel methods."""
    ...
    def test_user_id_and_created_at(self):
        """Test user ID and creation time."""
        user_1 = Amenity()
        sleep(2)
        user_2 = Amenity()
        sleep(2)
    ...
    def test_save_method(self):
        """Test the save method and if it updates."""
        instance5 = Amenity()
